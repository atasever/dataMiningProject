...
dataFile = open('results/helix_chemical_apriori_small_set.txt', 'r+')
allPermutations = Set()
...
permFile = open('results/helix_chemical_apriori_small_set_permutations.txt', 'w+')


results = {}
for x in allPermutations:
    count = 0
    dataFile = open('data/helixChemical.txt', 'r+')
    for line in dataFile:
